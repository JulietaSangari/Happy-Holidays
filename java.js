...
class paquete{
    ...
    Vender(cantidad){
        if(this.verificarStock(cantidad)){
            ...
            console.log("se vendieron "+ cantidad  + this.destino);
...
const paquete1 = new paquete("viajes con amigos", 1300, 20);
const paquete2 = new paquete("viajes de aventura", 1600, 30);
const paquete3 = new paquete("Lugares exoticos", 3000, 5);
